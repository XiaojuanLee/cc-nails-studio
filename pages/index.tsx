  ...
  return (
    <>
      ...
      <main className="pt-24">
        <div >
          <img src="/images/homepage.png" alt="CC Nails Studio Banner" className="mx-auto pt-0"/>
        </div>
      ...
      />
        ...
        <section className="bg-pink-50 py-10">
          <div className="container mx-auto text-center">
            ...
            <p className="text-3xl mt-4">Treat Yourself</p>
            <p className="mt-6 mx-40 text-2xl">
            ...
            <p className="mt-6 mx-40 text-3xl">
        ...
        <section className="py-10 mx-40">
          <div className="container mx-auto text-center">
            ...
            <p className='text-3xl'><span className='font-bold'>Phone: </span> 613-769-8599</p>
            <p className='text-3xl'><span className='font-bold'>Email: </span> CC.Nails.Studio01@gmail.com</p>
            <p className='text-3xl font-bold'>Business Hours: </p>
            <p className='text-3xl'>Monday-Friday: 9:30AM to 7:00PM</p>
            <p className='text-3xl'>Saturday: 10:00AM to 6:00PM</p>
            <p className='text-3xl'>Sunday: 11:00AM to 5:00PM</p>
          </div>
        ...
        <section className="py-10 mx-40 bg-pink-50">
          <div className="container mx-auto text-center">
            ...
            <p className=" mb-4 text-xl">Walk-Ins Welcome
            </p>
            {/* Embed Google Map */}
